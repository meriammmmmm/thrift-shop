    ...
    <div className="min-h-screen bg-white">
      ...
      <header className={`sticky top-0 z-50 transition-all duration-300 ${isScrolled ? 'shadow-lg' : 'shadow-sm'}`} style={{ backgroundColor: theme.background }}>
        ...
        <div className="text-center py-2 text-sm font-medium luxury-shimmer text-white" style={{ backgroundColor: theme.primary }}>
          <span>✨ WELCOME TO MERY ROSE ✨ NEW ARRIVALS DAILY | FREE SHIPPING ON ORDERS $75+ | CODE </span>
          <strong className="animate-bounce inline-block">ROSE50</strong>
          <span> 🌹</span>
        </div>
              ...
              <div className="flex items-center space-x-4">
                <div className="relative hidden md:block">
                  <input
                    ...
                    className="w-48 px-4 py-2 border border-gray-300 rounded-md text-sm focus:outline-none focus:ring-1 focus:ring-gray-400"
                  />
                ...
                >
                  ...
                  {wishlist.length > 0 && (
                    <span className="absolute -top-1 -right-1 text-white text-xs rounded-full h-5 w-5 flex items-center justify-center font-medium" style={{ backgroundColor: theme.primary }}>
                      {wishlist.length}
                    </span>
                  )}
                </button>
                ...
                >
                  ...
                  {cartCount > 0 && (
                    <span className="absolute -top-1 -right-1 text-white text-xs rounded-full h-5 w-5 flex items-center justify-center font-medium animate-bounce" style={{ backgroundColor: theme.primary }}>
                      {cartCount}
                    </span>
                  )}
                </button>
          ...
          <div className="relative z-10 h-full flex items-end pb-20">
            <div className="max-w-7xl mx-auto px-6 w-full">
              <div key={currentHeroSlide} className="max-w-xl animate-slideInLeft">
                <p className="text-white/80 text-xs md:text-sm font-medium mb-3 tracking-[0.2em] uppercase animate-fadeIn stagger-1">
                  {heroSlides[currentHeroSlide].subtitle}
                </p>
                <h1 className="text-3xl md:text-5xl lg:text-6xl font-light text-white mb-5 leading-tight tracking-tight animate-fadeIn stagger-2">
                  {heroSlides[currentHeroSlide].title}
                </h1>
                <p className="text-white/85 text-sm md:text-base mb-8 leading-relaxed font-light animate-fadeIn stagger-3">
                  {heroSlides[currentHeroSlide].description}
                </p>
                <button 
                  onClick={() => window.location.href = '/products'}
                  className="px-10 py-3.5 text-white font-medium text-xs tracking-[0.15em] uppercase border border-white/80 hover:bg-white hover:text-gray-900 transition-all duration-300 animate-fadeIn stagger-4"
                >
      ...
      <section className="py-10 bg-gradient-to-b from-gray-50 to-white overflow-hidden relative">
        ...
        <div className="max-w-7xl mx-auto px-6 relative z-10">
          <div className="text-center mb-16 scroll-animate scroll-fadeInDown">
            <span className="inline-block px-4 py-1.5 rounded-full text-[10px] font-medium uppercase tracking-[0.15em] mb-4" style={{ backgroundColor: `${theme.primary}15`, color: theme.primary }}>
              Trending Now
            </span>
            <h2 className="text-3xl md:text-4xl font-light text-gray-900 mb-3 tracking-tight">Most Loved Pieces</h2>
            <p className="text-gray-500 text-sm tracking-wide">Curated favorites from our community</p>
          </div>
          ...
          <div className="text-center mt-12 scroll-animate scroll-fadeInUp">
            <button 
              onClick={() => window.location.href = '/products'}
              className="px-10 py-3 rounded font-medium text-white text-xs tracking-[0.15em] uppercase transition-all duration-300 hover:opacity-90 magnetic-btn"
              style={{ backgroundColor: theme.primary }}
            >
              View All Products
            </button>
      ...
      <section className="relative py-20 text-white overflow-hidden animate-fadeIn" style={{ backgroundColor: theme.primary }}>
        <div className="absolute inset-0">
          <img 
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-6">
          ...
          <div className="flex items-center justify-center mb-12">
            ...
            <button 
              ...
              className="p-3 text-white/60 hover:text-white transition-all flex-shrink-0"
            ...
            <div className="flex items-center justify-center mx-4">
              {(() => {
                ...
                // Get 5 products centered around currentDailyEditIndex
                for (let i = -2; i <= 2; i++) {
          ...
          <div className="text-center animate-fadeIn">
            <h2 className="text-3xl md:text-4xl font-light mb-3 tracking-tight">Daily Edit</h2>
            <p className="text-xs mb-8 opacity-80 tracking-wide">
              Shop {weeklyProducts.length > 0 ? weeklyProducts.length : sortedProducts.length} finds curated just for you, refreshed daily.
            </p>
            
            <button 
              onClick={() => window.location.href = '/daily-edit'}
              className="px-9 py-3 border border-white/80 text-white font-medium text-xs tracking-[0.15em] uppercase hover:bg-white hover:text-gray-900 transition-all duration-300"
            >
              Shop Your Edit
            </button>
          </div>
      ...
      {showTestimonialsSection && testimonials.length > 0 && (
        <section className="py-24 relative overflow-hidden scroll-animate scroll-fadeInUp" style={{ background: 'linear-gradient(135deg, #f8fafc 0%, #e2e8f0 100%)' }}>
            ...
            {testimonials.length <= 3 ? (
              <div className={`flex items-stretch justify-center gap-8 max-w-7xl mx-auto ${testimonials.length === 1 ? 'flex-col' : testimonials.length === 2 ? 'flex-row' : 'flex-row'}`}>
                {testimonials.map((testimonial, index) => (
                  <div 
                    key={testimonial.id}
                    className={`group flex-shrink-0 ${testimonials.length === 3 && index === 1 ? 'w-[380px]' : 'w-[340px]'} scroll-animate scroll-zoomIn stagger-${index + 1}`}
                  >
                      ...
                      <div className="p-8 pt-20">
                        ...
                        <div className="flex justify-center mb-6">
                          <div className="relative">
                            ...
                            <div className={`relative ${testimonials.length === 3 && index === 1 ? 'w-24 h-24' : 'w-20 h-20'} rounded-full overflow-hidden ring-4 ring-white shadow-xl`}>
                              <img 
              ...
              <div className="relative">
                ...
                >
                  {testimonials.map((testimonial, index) => (
                    <div 
                      key={testimonial.id}
                      className={`flex-shrink-0 w-96 snap-center group scroll-animate scroll-zoomIn stagger-${Math.min(index + 1, 6)}`}
                    >
      ...
      <footer className="bg-gray-900 text-white py-16">
        <div className="max-w-7xl mx-auto px-4">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            <div>
              <h3 className="text-2xl font-bold mb-4">
                {company?.name?.toUpperCase() || 'THRIFT STORE'}
              </h3>
            ...
            <div>
              ...
              <ul className="space-y-2 text-gray-400">
                <li><button onClick={() => window.location.href = '/products'} className="hover:text-white transition-colors">All Products</button></li>
                <li><button onClick={() => window.location.href = '/daily-edit'} className="hover:text-white transition-colors">Daily Edit</button></li>
              </ul>
            </div>
          ...
          <div className="border-t border-gray-800 mt-12 pt-8 text-center text-gray-400">
            <p>&copy; 2024 {company?.name || 'Thrift Store'}. All rights reserved.</p>
          </div>
        </div>
      </footer>
